...
public class MarathonRecordingTest {
    ...
    public MarathonRecordingTest() {
        createMainUI();
        createTestApplication();
    }
    
    private void createMainUI() {
        mainFrame = new JFrame("Marathon Recording Test");
        ...
        scrollPane.setBorder(BorderFactory.createTitledBorder("Marathon Recording Log"));
    ...
    private void createTestApplication() {
        testAppFrame = new JFrame("Test Swing Application");
    ...
    private void startRecording() {
        ...
        logArea.append("=== Marathon Recording Started ===\n");
        logArea.append("Recording user interactions with Swing components...\n");
        System.out.println("Marathon recording started");
    ...
    private void stopRecording() {
        ...
        logArea.append("=== Marathon Recording Stopped ===\n");
        logArea.append("Total actions recorded: " + recordedActions.size() + "\n");
        System.out.println("Marathon recording stopped. Actions: " + recordedActions.size());
    ...
    private void replayActions() {
        ...
        logArea.append("=== Marathon Replay Started ===\n");
        System.out.println("Marathon replay started with " + recordedActions.size() + " actions");
        ...
        javax.swing.Timer timer = new javax.swing.Timer(1500, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (currentIndex < recordedActions.size()) {
                    ...
                    logArea.append("REPLAYING: " + action.toString() + "\n");
                    System.out.println("Replaying: " + action.toString());
                    currentIndex++;
                } else {
                    logArea.append("=== Marathon Replay Complete ===\n");
                    System.out.println("Marathon replay complete");
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            MarathonRecordingTest test = new MarathonRecordingTest();
            test.show();
            System.out.println("Marathon recording test application started");
        });
    }
} 